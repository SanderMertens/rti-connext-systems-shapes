    ...
    const struct DDS_TypeAllocationParams_t * alloc_params) 
{
    ...
    RTIOsapiHeap_allocateStructure(&(sample),ShapeType);
    if (sample == NULL) {
        return NULL;
    }
...
ShapeTypePluginSupport_create_key_ex(RTIBool allocate_pointers){
    ...
    RTIOsapiHeap_allocateStructure(&(key),ShapeTypeKeyHolder);
    ...
    const struct DDS_TypeAllocationParams_t * alloc_params) 
{
    ...
    RTIOsapiHeap_allocateStructure(&(sample),ShapeTypeExtended);
    if (sample == NULL) {
        return NULL;
    }
...
ShapeTypeExtendedPluginSupport_create_key_ex(RTIBool allocate_pointers){
    ...
    RTIOsapiHeap_allocateStructure(&(key),ShapeTypeExtendedKeyHolder);
